...
echo "
##############################################################################################################
# This script works on password proteced devices, but requires you to enter the download mode manually.      #
# USB Debugging and losckscreen passcode/password are not needed, to flash the device and extract the data.  #
##############################################################################################################
"
...
echo "Put the device into download mode. Press and hold volume down + home + power, and confirm with volume up. Plug in the cable"
